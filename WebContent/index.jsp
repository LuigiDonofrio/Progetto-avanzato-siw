      ...
      <div class="row row-offcanvas row-offcanvas-right">
		...
		<ul>
			...
			<li><h:form>
					...
					<h:commandLink styleClass = "list-group-item" action="#{productController.listProducts}"
						value="List all Products" />
				</h:form>
				</li>
			<li><a href='<c:url value="/faces/newUser.jsp" />'> Registra nuovo utente</a></li>
	
			<li><a href='<c:url value="/faces/searchProdbyName.jsp" />'> Cerca prodotti per nome</a></li>
		</ul>
